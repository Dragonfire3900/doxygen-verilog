...
#include "vhdlcode.h" //TODO: - Tang - Not sure if this should be included
#include "regex.h"
#include "plantuml.h"
...
QCString VhdlDocGen::getProcessNumber()
{
  ...
  //TODO: - Tang - This doesn't match this function?
  // if(optVerilog)
  //   qcs="ALWAYS_";
  //
...
//TODO: - Tang - This might not be needed
