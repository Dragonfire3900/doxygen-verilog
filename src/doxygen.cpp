...
//TODO: Check where these includes went
//#include "VPreProc.h"
//#include <qfileinfo.h>
// #include <qfile.h>
// #include <qdir.h>
                      ...
                      ClangTUParser *clangParser,bool newTU)
{
      ...
      parser.needsPreprocessing(extension))
  {
    std::string inBuf;
    msg("Preprocessing {}...\n",fn);
    //TODO: Tang - Could the readInputFile functions be moved up? That way there is less branching
    if(Config_getBool(OPTIMIZE_OUTPUT_VERILOG))
    {
      VerilogPreProc defProc;
      readInputFile(fileName,inBuf);
      QCString s=defProc.performPreprocessing(fi,true).data(); //TODO: Tang - Check if this makes sense
...
void initDoxygen()
{
  ...
  Doxygen::parserManager->registerParser("tcl",          make_parser_factory<NullOutlineParser>(),
                                                         make_parser_factory<TclLanguageScanner>()); //TODO: Tang - Change these to parsers instead of scanners
  ...
  Doxygen::parserManager->registerParser("v",            make_parser_factory<NullOutlineParser>(),
                                                         make_parser_factory<VerilogScanner>()); //TODO: Tang - Change these to parsers instead of scanners
